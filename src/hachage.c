...
void rec_hachage_type_instruction(instruction e, Liste_hach L, char *mot1,
				  char *mot2, char *mot3)
{
    Liste_hach p = L;
    while (!est_vide_hachage(p) && (strcasecmp(p->val, e) != 0)) {
...
void information(char *oppcode, char *fonction, char *a1, char *a2,
